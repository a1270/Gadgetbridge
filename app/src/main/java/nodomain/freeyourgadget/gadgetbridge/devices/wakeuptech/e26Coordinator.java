...
public class e26Coordinator extends AbstractDeviceCoordinator {

    protected static final Logger LOG = LoggerFactory.getLogger(e26Coordinator.class);
    ...
    public Collection<? extends ScanFilter> createBLEScanFilters() {
        ParcelUuid uuid = new ParcelUuid(wakeuptechConstants.UUID_SERVICE_WAKEUPTECH);
    ...
    public DeviceType getSupportedType(GBDeviceCandidate candidate) {
        ...
        if (name != null && name.startsWith("E26")) {
            return DeviceType.WAKEUPE26;
        }
...
//        String tmode = prefs.getString(SettingsActivity.PRE, getContext().getString(R.string.p_timeformat_24h));
//
...
//    }
    ...
    public static int getGoal() {
        ...
        return (activityUser.getStepsGoal() / 1000);
    }
